// src/components/MoreOptionsButton.js
import React from 'react';
import styles from './MoreOptionsButton.module.css';

// Simple SVG Ellipsis Icon
const EllipsisIcon = () => (
...
function MoreOptionsButton({ onClick, disabled, ariaLabel = "More options" }) {
  return (
    <button
        onClick={onClick}
